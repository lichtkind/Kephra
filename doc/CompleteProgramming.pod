...
=head1 Complete Programming
    ...
    that evolved from and for the development of the Kephra editor.
...
=head3 DISCLAIMER
    ...
    I strongly dislike strict rules imposed on me and make fun of people producing
    ...
    So I had to use just two letters (CP) to sound even more important.

    This document is long and you might not want to read it.
    I understand that and pushed myself to shorten it where I could.
    The next chapter provides you with the basic ideas.
    But there is an even more destilled essence:
    Honesty, trust and understanding are the foremost productivity boosters.
    So it is not hard to grasp why psychological aspects are most important
    to software engineering and why much of political and business culture
    undermines the very thing they adore so much.
...
=head3 Fundamental Ideas
    ...
    5) Each "parcel" in one of these "boxes" is a fully functional,
