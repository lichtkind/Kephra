...
structure, you can leave out some. Essential are only stage and goal,
but in Kephra we use all 6: function, module, feature, stage, goal and sketch.
...
The purpose of a functional prototype cell is practical research.
...
this function cell to work on a related issue.

Since functional prototypes aim for the simplest and fastest good solution,
...
Functional protos are generally a good, searchable store of documentation
...
which is a copy from /dev/stage/current_stage_name.
...
module and feature cells belong to a certain stage where they sit under
    - /dev/stage/name/module/name
    - /dev/stage/name/feature/name.

Since function cells are plenty are should be sorted by topic since over 20
subdirectories is too much for orientation

They will have their own /doc, /lib, /bin ...
