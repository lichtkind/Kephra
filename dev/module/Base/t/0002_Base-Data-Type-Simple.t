...
is( $Tvalue->get_name, 'value',      'remembered type name');
is( $Tvalue->get_default_value, '',  'remembered default value');
...
is( ref $Tvclone, $pkg,              'recreated object for type "value"');
is( $Tvclone->get_name, 'value',     'type name is correct');
is( $Tvclone->get_default_value, '', 'types default value is correct');
...
is( $Tbool->get_name, 'bool',        'remembered type name');
is( $Tbool->get_default_value, 0,    'remembered default value');
...
is( $Tbclone->get_name, 'bool',      'remembered type name');
is( $Tbclone->get_default_value, 0,  'remembered default value');
...
is( $Tstr->get_name, 'str',          'remembered type str');
