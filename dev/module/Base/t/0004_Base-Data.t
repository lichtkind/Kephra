...
use Kephra::Base::Data qw/clone_item clone_list/;
use TestClass;


is( clone_item(1.5),                     1.5, 'cloned number');
is( clone_item('string'),           'string', 'cloned string');

my $ref = \7.5;
my $clone = clone_item($ref);
