...
is( $store->type_shortcut('basic','superkalifrailistisch'),undef,         'can not get shortcut from unknown basic type');
is( $store->type_shortcut('param','superkalifrailistisch'),undef,         'can not get shortcut from unknown parametric type');
...
is( $store->type_shortcut('no_ref','int'),                 undef,         'got shortcut of basic type "int"');
is( $store->type_shortcut('basic','int'),                    '#',         'got shortcut of basic type "int"');
...
is( $store->type_shortcut('basic','num'),                    '+',         'got shortcut of basic type "num"');
...
is( $store->type_shortcut('basic','int'),                  undef,         'basic type "int" has no more shortcut');
...
package TypeTester; 
is( $store->type_shortcut('param','index'),                  '^',         'got shortcut of parametric type "index" of "array"');
...
is( $store->type_shortcut('%'),                            undef,         'shortcut % was not added');
...
is( $ostore->type_shortcut('basic','str'),                 undef,         'basic type "str" has still no shortcut');
is( $ostore->type_shortcut('param','ref'),                 undef,         'parametric type "ref of name" has still no shortcut');
...
is( $ostore->type_shortcut('basic','str'),                 undef,         'basic type "str" has no shortcut again');
is( $ostore->type_shortcut('param','ref'),                 undef,         'parametric type "ref of name" has no shortcut again');
...
is( $ostore->type_shortcut('basic', 'int'),                 undef,         'basic type "int" has still no shortcut');
