...
is( ref $def->auto_accessors,                               'HASH',        'created data attribute definition with combined getter/setter');
...
$def = mk_attr_def({%$req_properies, auto_get => 'get', auto_set => {set => 'private'}});
is( ref $def->auto_accessors,                               'HASH',        'created data attribute definition with sole scalar getter');
is( $def->auto_accessors->{'get'}{'get'},                 'access',        'getter has right scope');
is( $def->auto_accessors->{'set'}{'set'},                'private',        'setter has right scope');

$def = mk_attr_def({%$req_properies, auto_get => {get => 'public'}, auto_set => 'set'});
is( ref $def->auto_accessors,                               'HASH',        'created data attribute definition with sole scalar setter');
is( $def->auto_accessors->{'get'}{'get'},                 'public',        'getter has right scope');
is( $def->auto_accessors->{'set'}{'set'},                 'access',        'setter has right scope');

$def = mk_attr_def({%$req_properies, auto_get => {gset => 'public'}, auto_set => 'gset'});
is( ref $def->auto_accessors,                               'HASH',        'created data attribute definition with sole scalar setter as getter/setter');
is( ref $def->auto_accessors->{'gset'},                     'HASH',        'definition of getter/setter is HASH');
