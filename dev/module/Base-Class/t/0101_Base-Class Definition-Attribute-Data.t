...
is( ref $def->auto_accessors,                               'HASH',        'check getter of "auto methods" property');
...
my $def = mk_attr_def({%$req_properies, get => 'get', set => 'set'});
...
my $def = mk_attr_def({%$req_properies, get => ['get1', 'get2']});
...
my $def = mk_attr_def({%$req_properies, get => ['get1', 'get2'], set => ['set1', 'set2']});
...
$def = mk_attr_def({%$req_properies, auto_get => {get => 'public'}});
...
is( $def->auto_accessors->{'get'},                        'public',        'got the scope of the autogenerated getter');
...
is( ($def->accessor_names)[0],                               undef,        'the only name is undef');
is( $def->auto_accessors->{'get'},                        'public',        'got the scope of the autogenerated getter');
is( ref $def->auto_accessors->{'set'},                     'ARRAY',        'got defnition of the autogenerated setter');
is( $def->auto_accessors->{'set'}[0],                        undef,        'the autogenerated accessor is a pure setter');
is( $def->auto_accessors->{'set'}[1],                    'private',        'got the scope of the autogenerated setter');

$def = mk_attr_def({%$req_properies, auto_get => {gset => 'public'}, auto_set => {gset => 'private'}});
is( $def->auto_accessors->{'gset'}[0],                    'public',        'got the scope of the autogenerated detter');
is( $def->auto_accessors->{'gset'}[1],                   'private',        'got the scope of the autogenerated setter');
...
my $req_properies = {name => 'name', help => 'help', type => 'int', get => 'get'};
