...
is( Kephra::Base::Class::Attribute::add_getter($real_attr, $subscope.'::geta', $aself ), 1, 'mounted a getter via add_getter');
is( $aself->geta(), 2, 'mounted a getter works');
is( Kephra::Base::Class::Attribute::add_setter($real_attr, $subscope.'::seta', $aself ), 1, 'mounted a setter via add_getter');
...
is( Kephra::Base::Class::Attribute::add_getsetter($real_attr, $subscope.'::gseta', $aself ), 1, 'mounted a getter/setter via add_getter');
