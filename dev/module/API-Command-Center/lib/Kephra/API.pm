...
#sub error        { Kephra::LogBook::log_enry('msg#error', @_ ) } # sth. crashed
#sub warning      { Kephra::LogBook::log_enry('msg#warning'), @_} # mostly bad parameter data prevented work 
#sub note         { Kephra::LogBook::log_enry('msg#note'), @_   } # potential problems
#sub report       { Kephra::LogBook::log_enry('msg#report'), @_ } # debugging
