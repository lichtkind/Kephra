...
=head2 Preamble
    ...
    It evolved from and for the development of the Kephra editor.
    ...
    The word cell refers to an organisational subunit, which lives in 
    a directory, that reflects its role within the overall project.
    
    Cells are the core concept, because they modularize the development,
    which keeps complexity manageable.
...
=item changeable (small, well organized files)
