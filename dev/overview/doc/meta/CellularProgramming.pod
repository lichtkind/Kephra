...
=head3 Basic Steps
    ...
    1) (Un-)structured attempt to define the goal on user level:
       ...
       Only as precise to be a helpful guide, but update and iterate whenever 
       the goal changes.

    2) Sketch your goal by writing high level documentation.
       Use such docs early for sharing with coprogrammer, and audience/boss.
       Keep it always updated when plan changes.

    3) Create dummy/empty classes, with dummy methods and comments where important.
