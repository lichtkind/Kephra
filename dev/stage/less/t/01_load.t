...
use_ok( 'Kephra::App::Editor::SyntaxMode::JSON' );
use_ok( 'Kephra::App::Editor::SyntaxMode::Markdown' );
use_ok( 'Kephra::App::Editor::SyntaxMode::No' );
use_ok( 'Kephra::App::Editor::SyntaxMode::Perl' );
use_ok( 'Kephra::App::Editor::SyntaxMode::Python' );
use_ok( 'Kephra::App::Editor::SyntaxMode::Ruby' );
use_ok( 'Kephra::App::Editor::SyntaxMode::Rust' );
use_ok( 'Kephra::App::Editor::SyntaxMode::YAML' );
