...
sub mount {
    ...
    Wx::Event::EVT_MENU( $win, 12300, sub { $ed->expand_selecton      });
    Wx::Event::EVT_MENU( $win, 12310, sub { $ed->shrink_selecton      });
    Wx::Event::EVT_MENU( $win, 12400, sub { $ed->duplicate            });
    ...
    Wx::Event::EVT_MENU( $win, 15410, sub { $ed->set_EOL_lf           });
    Wx::Event::EVT_MENU( $win, 15420, sub { $ed->set_EOL_cr           });
    Wx::Event::EVT_MENU( $win, 15430, sub { $ed->set_EOL_crlf         });
