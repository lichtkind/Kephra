...
sub mount {
    ...
    Wx::Event::EVT_MENU( $win, 12210, sub { Kephra::App::Editor::Edit::copy( $win->{'ed'} ) });
    Wx::Event::EVT_MENU( $win, 12220, sub { $win->{'ed'}->Paste });
    Wx::Event::EVT_MENU( $win, 12230, sub { Kephra::App::Editor::Edit::replace( $win->{'ed'} ) });
    ...
    Wx::Event::EVT_MENU( $win, 12400, sub { Kephra::App::Editor::Edit::duplicate( $win->{'ed'} )});
    Wx::Event::EVT_MENU( $win, 13100, sub { Kephra::App::Editor::MoveText::left( $win->{'ed'} )});
    Wx::Event::EVT_MENU( $win, 13110, sub { Kephra::App::Editor::MoveText::right( $win->{'ed'} )});
    Wx::Event::EVT_MENU( $win, 13120, sub { Kephra::App::Editor::MoveText::up( $win->{'ed'} ) });
    Wx::Event::EVT_MENU( $win, 13130, sub { Kephra::App::Editor::MoveText::down( $win->{'ed'} )});
    Wx::Event::EVT_MENU( $win, 13200, sub { Kephra::App::Editor::Tool::toggle_block_comment( $win->{'ed'} ) });
    Wx::Event::EVT_MENU( $win, 13210, sub { Kephra::App::Editor::Tool::toggle_comment( $win->{'ed'} ) });
    Wx::Event::EVT_MENU( $win, 13300, sub { Kephra::App::Editor::Tool::toggle_block_comment( $win->{'ed'} ) });
    Wx::Event::EVT_MENU( $win, 13310, sub { Kephra::App::Editor::Tool::toggle_comment( $win->{'ed'} ) });
