...
sub mount {
    ...
    $zoom_menu->Append( 16310, "Zoom &In\tCtrl+-", '' );
    $zoom_menu->Append( 16320, "Zoom &Out\tCtrl++", '' );
    $zoom_menu->AppendSeparator();
    $zoom_menu->AppendRadioItem( 16330, 'Zoom Level -10', '' );
    $zoom_menu->AppendRadioItem( 16331, 'Zoom Level - 9', '' );
    $zoom_menu->AppendRadioItem( 16332, 'Zoom Level - 8', '' );
    $zoom_menu->AppendRadioItem( 16333, 'Zoom Level - 7', '' );
    $zoom_menu->AppendRadioItem( 16334, 'Zoom Level - 6', '' );
    $zoom_menu->AppendRadioItem( 16335, 'Zoom Level - 5', '' );
    $zoom_menu->AppendRadioItem( 16336, 'Zoom Level - 4', '' );
    $zoom_menu->AppendRadioItem( 16337, 'Zoom Level - 3', '' );
    $zoom_menu->AppendRadioItem( 16338, 'Zoom Level - 2', '' );
    $zoom_menu->AppendRadioItem( 16339, 'Zoom Level - 1', '' );
    $zoom_menu->AppendRadioItem( 16340, 'Zoom Level   0', '' );
    $zoom_menu->AppendRadioItem( 16341, 'Zoom Level   1', '' );
    $zoom_menu->AppendRadioItem( 16342, 'Zoom Level   2', '' );
    $zoom_menu->AppendRadioItem( 16343, 'Zoom Level   3', '' );
    $zoom_menu->AppendRadioItem( 16344, 'Zoom Level   4', '' );
    $zoom_menu->AppendRadioItem( 16345, 'Zoom Level   5', '' );
    $zoom_menu->AppendRadioItem( 16346, 'Zoom Level   6', '' );
    $zoom_menu->AppendRadioItem( 16347, 'Zoom Level   7', '' );
    $zoom_menu->AppendRadioItem( 16348, 'Zoom Level   8', '' );
    $zoom_menu->AppendRadioItem( 16349, 'Zoom Level   9', '' );
    $zoom_menu->AppendRadioItem( 16350, 'Zoom Level  10', '' );
    $zoom_menu->AppendRadioItem( 16351, 'Zoom Level  11', '' );
    $zoom_menu->AppendRadioItem( 16352, 'Zoom Level  12', '' );
    $zoom_menu->AppendRadioItem( 16353, 'Zoom Level  13', '' );
    $zoom_menu->AppendRadioItem( 16354, 'Zoom Level  14', '' );
    $zoom_menu->AppendRadioItem( 16355, 'Zoom Level  15', '' );
    $zoom_menu->AppendRadioItem( 16356, 'Zoom Level  16', '' );
    $zoom_menu->AppendRadioItem( 16357, 'Zoom Level  17', '' );
    $zoom_menu->AppendRadioItem( 16358, 'Zoom Level  18', '' );
    $zoom_menu->AppendRadioItem( 16359, 'Zoom Level  19', '' );
    $zoom_menu->AppendRadioItem( 16360, 'Zoom Level  20', '' );
    
    $view_menu->AppendCheckItem( 16420, "Line Wra&p",  "" );
    ...
    Wx::Event::EVT_MENU( $win, 16330, sub { $win->{'ed'}->set_zoom_level(-10)        });
    Wx::Event::EVT_MENU( $win, 16331, sub { $win->{'ed'}->set_zoom_level(- 9)        });
    Wx::Event::EVT_MENU( $win, 16332, sub { $win->{'ed'}->set_zoom_level(- 8)        });
    Wx::Event::EVT_MENU( $win, 16333, sub { $win->{'ed'}->set_zoom_level(- 7)        });
    Wx::Event::EVT_MENU( $win, 16334, sub { $win->{'ed'}->set_zoom_level(- 6)        });
    Wx::Event::EVT_MENU( $win, 16335, sub { $win->{'ed'}->set_zoom_level(- 5)        });
    Wx::Event::EVT_MENU( $win, 16336, sub { $win->{'ed'}->set_zoom_level(- 4)        });
    Wx::Event::EVT_MENU( $win, 16337, sub { $win->{'ed'}->set_zoom_level(- 3)        });
    Wx::Event::EVT_MENU( $win, 16338, sub { $win->{'ed'}->set_zoom_level(- 2)        });
    Wx::Event::EVT_MENU( $win, 16339, sub { $win->{'ed'}->set_zoom_level(- 1)        });
    Wx::Event::EVT_MENU( $win, 16340, sub { $win->{'ed'}->set_zoom_level(  0)        });
    Wx::Event::EVT_MENU( $win, 16341, sub { $win->{'ed'}->set_zoom_level(  1)        });
    Wx::Event::EVT_MENU( $win, 16342, sub { $win->{'ed'}->set_zoom_level(  2)        });
    Wx::Event::EVT_MENU( $win, 16343, sub { $win->{'ed'}->set_zoom_level(  3)        });
    Wx::Event::EVT_MENU( $win, 16344, sub { $win->{'ed'}->set_zoom_level(  4)        });
    Wx::Event::EVT_MENU( $win, 16345, sub { $win->{'ed'}->set_zoom_level(  5)        });
    Wx::Event::EVT_MENU( $win, 16346, sub { $win->{'ed'}->set_zoom_level(  6)        });
    Wx::Event::EVT_MENU( $win, 16347, sub { $win->{'ed'}->set_zoom_level(  7)        });
    Wx::Event::EVT_MENU( $win, 16348, sub { $win->{'ed'}->set_zoom_level(  8)        });
    Wx::Event::EVT_MENU( $win, 16349, sub { $win->{'ed'}->set_zoom_level(  9)        });
    Wx::Event::EVT_MENU( $win, 16350, sub { $win->{'ed'}->set_zoom_level( 10)        });
    Wx::Event::EVT_MENU( $win, 16351, sub { $win->{'ed'}->set_zoom_level( 11)        });
    Wx::Event::EVT_MENU( $win, 16352, sub { $win->{'ed'}->set_zoom_level( 12)        });
    Wx::Event::EVT_MENU( $win, 16353, sub { $win->{'ed'}->set_zoom_level( 13)        });
    Wx::Event::EVT_MENU( $win, 16354, sub { $win->{'ed'}->set_zoom_level( 14)        });
    Wx::Event::EVT_MENU( $win, 16355, sub { $win->{'ed'}->set_zoom_level( 15)        });
    Wx::Event::EVT_MENU( $win, 16356, sub { $win->{'ed'}->set_zoom_level( 16)        });
    Wx::Event::EVT_MENU( $win, 16357, sub { $win->{'ed'}->set_zoom_level( 17)        });
    Wx::Event::EVT_MENU( $win, 16358, sub { $win->{'ed'}->set_zoom_level( 18)        });
    Wx::Event::EVT_MENU( $win, 16359, sub { $win->{'ed'}->set_zoom_level( 19)        });
    Wx::Event::EVT_MENU( $win, 16360, sub { $win->{'ed'}->set_zoom_level( 20)        });
